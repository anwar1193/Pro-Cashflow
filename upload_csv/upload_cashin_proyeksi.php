...
<html lang="en">
	<head>
		...
		<title>Import Data Cashin Proyeksi</title>
	...
	<body>
		...
		<div style="padding: 0 15px;">
			...
			<a href="http://localhost/Pro-Cashflow/input_cashin" class="btn btn-danger pull-right">
				Kembali
			</a>

			<h3>Import Data Cashin Proyeksi</h3>
			<hr>

			<!-- Buat sebuah tag form dan arahkan action nya ke file ini lagi -->
			<form method="post" action="" enctype="multipart/form-data">
				<a href="file_csv/proyeksi_cashin.csv" class="btn btn-primary">
					Download Format
				</a>

                <a href="file_csv/proyeksi_cashin_contoh.csv" class="btn btn-warning">
			...
			if(isset($_POST['preview'])){
				...
				if($ext == "csv"){
					...
					echo "<form method='post' action='upload_cashin_proyeksi_exec.php'>";
