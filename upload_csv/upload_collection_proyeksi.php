...
<html lang="en">
	<head>
		...
		<title>Import Data Collection Proyeksi</title>
	...
	<body>
		...
		<div style="padding: 0 15px;">
			...
			<a href="http://localhost/Pro-Cashflow/collection_proyeksi" class="btn btn-danger pull-right">
				Kembali
			</a>

			<h3>Import Data Collection Proyeksi</h3>
			<hr>

			<!-- Buat sebuah tag form dan arahkan action nya ke file ini lagi -->
			<form method="post" action="" enctype="multipart/form-data">
				<a href="file_csv/proyeksi_collection.csv" class="btn btn-primary">
					Download Format
				</a>

                <a href="file_csv/proyeksi_collection_contoh.csv" class="btn btn-warning">
			...
			if(isset($_POST['preview'])){
				...
				if($ext == "csv"){
					...
					echo "<form method='post' action='upload_collection_proyeksi_exec.php'>";
