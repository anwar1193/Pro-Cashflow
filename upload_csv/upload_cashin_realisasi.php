...
<html lang="en">
	<head>
		...
		<title>Import Data Cashin Realisasi</title>
	...
	<body>
		...
		<div style="padding: 0 15px;">
			...
			<a href="http://localhost/Pro-Cashflow/input_cashin_real" class="btn btn-danger pull-right">
				Kembali
			</a>
			...
			<form method="post" action="" enctype="multipart/form-data">
				<a href="file_csv/realisasi_cashin.csv" class="btn btn-primary">
					Download Format
				</a>

                <a href="file_csv/realisasi_cashin_contoh.csv" class="btn btn-warning">
			...
			if(isset($_POST['preview'])){
				...
				if($ext == "csv"){
					...
					echo "<form method='post' action='upload_cashin_realisasi_exec.php'>";
