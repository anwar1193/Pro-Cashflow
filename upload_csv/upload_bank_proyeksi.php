...
<html lang="en">
	<head>
		...
		<title>Import Data Bank Proyeksi</title>
	...
	<body>
		...
		<div style="padding: 0 15px;">
			...
			<a href="http://localhost/Pro-Cashflow/bank_proyeksi" class="btn btn-danger pull-right">
				Kembali
			</a>

			<h3>Import Data Bank Proyeksi</h3>
			<hr>

			<!-- Buat sebuah tag form dan arahkan action nya ke file ini lagi -->
			<form method="post" action="" enctype="multipart/form-data">
				<a href="file_csv/proyeksi_bank.csv" class="btn btn-primary">
					Download Format
				</a>

                <a href="file_csv/proyeksi_bank_contoh.csv" class="btn btn-warning">
			...
			if(isset($_POST['preview'])){
				...
				if($ext == "csv"){
					...
					echo "<form method='post' action='upload_bank_proyeksi_exec.php'>";
