...
<html lang="en">
	<head>
		...
		<title>Import Data Cashout Realisasi</title>
	...
	<body>
		...
		<div style="padding: 0 15px;">
			...
			<a href="http://localhost/Pro-Cashflow/input_cashout_real" class="btn btn-danger pull-right">
				Kembali
			</a>

			<h3>Import Data Cashout Realisasi</h3>
			<hr>

			<!-- Buat sebuah tag form dan arahkan action nya ke file ini lagi -->
			<form method="post" action="" enctype="multipart/form-data">
				<a href="file_csv/realisasi_cashout.csv" class="btn btn-primary">
					Download Format
				</a>

                <a href="file_csv/realisasi_cashout_contoh.csv" class="btn btn-warning">
			...
			if(isset($_POST['preview'])){
				...
				if($ext == "csv"){
					...
					echo "<form method='post' action='upload_cashout_realisasi_exec.php'>";
