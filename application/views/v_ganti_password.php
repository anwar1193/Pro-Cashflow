        ...
        <div class="col-sm-4 col-sm-offset-4">
          ...
          <form method="post" action="<?php echo base_url().'ganti_password/update_password' ?>">
            ...
            <div class="form-group">
              ...
              <input type="text" name="nama" id="nama" value="<?php echo $nama ?>" class="form-control" readonly>
            </div>

            <div class="form-group">
              <label for="username">Username <span style="color: red;">*</span></label>
              <input type="text" name="username" value="<?php echo $username ?>" id="username" class="form-control" readonly autocomplete="off">
            </div>
