  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Input Data Cash-Out Sub-Item</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Input Cash-Out Sub-Item</li>
      </ol>
    </section>
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-sm-4 col-sm-offset-4">
              ...
              <h3>Input Data Cash-Out Sub-Item</h3>
              <hr style="border-width: 4px;">
              <form method="post" action="<?php echo base_url().'pengaturan_cashout/simpan_cashout_sub' ?>">
