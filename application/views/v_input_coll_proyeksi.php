...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <?php echo $this->session->flashdata('pesan_sukses'); ?>
      ...
      <h1>
        Input Data Cash-In (Proyeksi Collection)
          ...
          <div class="box">
            <div class="box-header with-border">
              ...
              <span style="margin-left: 38%">
                <a href="<?php echo base_url().'upload_csv/upload_collection_proyeksi.php' ?>" type="button" class="btn btn-info btn-xs">
                  <i class="fa fa-upload"></i> Upload Proyeksi
                </a>
              </span>

              <span>
                <a href="<?php echo base_url().'collection_proyeksi/view_inputan' ?>" type="button" class="btn btn-warning btn-xs"><i class="fa fa-eye"></i> Lihat Yang Sudah Diinput</a>
              </span>
            ...
            <div class="box-body">
              ...
              <!-- Isi Form -->
                ...
                <!-- FORM (C)-->
                <form method="post" action="<?php echo base_url().'collection_proyeksi/tambah' ?>">
                <div class="row">
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Upload Proyeksi Collection</h4>
          <br>
          <span>
            <a href="<?php echo base_url().'upload_excel/proyeksi_collection.xlsx' ?>" class="btn btn-info btn-xs">
        ...
        <div class="modal-footer">
          <form method="post" action="<?php echo base_url().'upload_excel/upload_proyeksi_collection.php' ?>" enctype="multipart/form-data">
