        ...
        <div class="col-sm-8">
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Update Data Proyeksi Cashout</h3>
            ...
            <div class="box-body">
             ...
             <form method="post" action="<?php echo base_url().'edit_cashoutproj/update' ?>">
               ...
               <div class="form-group">
                ...
                <a href="<?php echo base_url().'edit_cashoutproj' ?>" class="btn btn-danger btn-sm"><i class="fa fa-times"></i> Batal</a>
