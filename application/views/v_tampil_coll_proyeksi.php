...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <?php echo $this->session->flashdata('pesan_sukses'); ?>
      ...
      <h1>
        View Hasil Input Proyeksi Cash-In
    ...
    <section class="content">
        ...
        <div class="col-sm-10">
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Data Hasil Inputan (Default Hari Ini)</h3>
            ...
            <div class="box-body table-responsive">
              ...
              <div class="row">
                <form method="post" action="<?php echo base_url().'collection_proyeksi/view_inputan' ?>">
                ...
                <form method="post" action="<?php echo base_url().'collection_proyeksi/hapus_cashin' ?>">
                  <div class="col-sm-3">
              	...
              	<tbody>
              		...
              		<tr>
              			...
              			<td style="text-align: center;">
              				<!-- <a href="<?php echo base_url().'collection_proyeksi/edit_cashin/'.$data['id'] ?>" class="btn btn-success btn-xs"><i class="fa fa-edit"></i> Edit</a> -->

                      <a href="<?php echo base_url().'collection_proyeksi/detail_cashin/'.$data['kode_status'].'/'.$data['tanggal'] ?>" class="btn btn-warning btn-xs" target="_blank">
      ...
      <!-- Tombol Kembali -->
      <a href="<?php echo base_url().'collection_proyeksi' ?>" class="btn btn-danger"><i class="fa fa-backward"></i> Kembali</a>
