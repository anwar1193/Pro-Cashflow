        ...
        <div class="col-sm-10">
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Data Note</h3>
            ...
            <form method="post" action="<?php echo base_url().'note' ?>">
              <div class="row">
              ...
              <table class="table table-bordered" style="margin-top: 10px;">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="<?php echo base_url().'note/edit/'.$data['id'] ?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i> Edit</a>   
                    </td>
                  </tr>
                  <?php 
                    }
