        ...
        <div class="col-sm-10">
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Data Kas Besar Cabang</h3>
            ...
            <form method="post" action="<?php echo base_url().'input_kbc/tampil_edit' ?>">
              <div class="row">
              ...
              <table class="table table-bordered" style="margin-top: 10px;">
              	...
              	<tbody>
              		...
              		<tr>
              			...
              			<td><?php echo number_format($data['kbc'],0,'.',','); ?></td>
              			<td>
                      <a href="<?php echo base_url().'input_kbc/edit/'.$data['id'] ?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i> Edit</a>   
                    </td>
              		</tr>
                  <?php 
                    }
