      ...
      <div class="row">
        ...
        <div class="col-sm-10">
          ...
          <div class="box">
            ...
            <form method="post" action="<?php echo base_url().'input_saldo_awal/tampil_edit' ?>">
              <div class="row">
              ...
              <table class="table table-bordered" style="margin-top: 10px;">
              	<thead>
              		<tr style="background-color: #F7AE3C">
              			<th>NO</th>
              			<th>Tanggal</th>
              			<th>Saldo Awal Projection</th>
              			<th>Saldo Awal Realisasi</th>
              			<th>Action</th>
              		</tr>
              	</thead>
              	...
              	<tbody>
              		...
              		<tr>
              			...
              			<td><?php echo number_format($data['saldo_awal_proj'],0,'.',','); ?></td>
              			<td><?php echo number_format($data['saldo_awal_real'],0,'.',','); ?></td>
              			<td>
                      <a href="<?php echo base_url().'input_saldo_awal/edit/'.$data['id'] ?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i> Edit</a>   
                    </td>
              		</tr>
                  <?php 
                    }
