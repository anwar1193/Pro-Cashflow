        ...
        <div class="col-sm-10">
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Realisasi Cash-In</h3>

              <span style="margin-left: 38%">
                <a href="<?php echo base_url().'upload_csv/upload_cashin_realisasi.php' ?>" type="button" class="btn btn-info btn-xs">
                  <i class="fa fa-upload"></i> Upload Realisasi
                </a>
              </span>

              <span>
                <a href="<?php echo base_url().'input_cashin_real/view_inputan' ?>" type="button" class="btn btn-warning btn-xs"><i class="fa fa-eye"></i> Lihat Yang Sudah Diinput</a>
              </span>
            ...
            <div class="box-body">
              ...
              <!-- Isi Form -->
                ...
                <!-- FORM (A)-->
                <form method="post" action="<?php echo base_url().'input_cashin_real/tambah' ?>">
                <div class="row">
                ...
                <input type="text" name="status" value="Pencairan Bank" hidden>
                  ...
                  <div class="col-xs-4">
                    ...
                    <!-- <a href="http://upload-cashflow.procarfinance.com/cashin_real.php?kode=A&status=Pencairan_Bank" class="btn btn-primary btn-sm" style="margin-top: 25px;"><i class="fa fa-upload"></i> Upload</a> -->
                ...
                <input type="text" name="status" value="Pelunasan Awal" hidden>
                  ...
                  <div class="col-xs-4">
                    ...
                    <!-- <a href="http://upload-cashflow.procarfinance.com/cashin_real.php?kode=E&status=Pelunasan_Awal" class="btn btn-primary btn-sm" style="margin-top: 25px;"><i class="fa fa-upload"></i> Upload</a> -->
                ...
                <input type="text" name="status" value="Penjualan AYDA" hidden>
                  ...
                  <div class="col-xs-4">
                    ...
                    <!-- <a href="http://upload-cashflow.procarfinance.com/cashin_real.php?kode=F&status=Penjualan_AYDA" class="btn btn-primary btn-sm" style="margin-top: 25px;"><i class="fa fa-upload"></i> Upload</a> -->
                ...
                <input type="text" name="status" value="Recovery WO" hidden>
                  ...
                  <div class="col-xs-4">
                    ...
                    <!-- <a href="http://upload-cashflow.procarfinance.com/cashin_real.php?kode=G&status=Recovery_WO" class="btn btn-primary btn-sm" style="margin-top: 25px;"><i class="fa fa-upload"></i> Upload</a> -->
                ...
                <input type="text" name="status" value="Penggantian Klaim Asuransi" hidden>
                  ...
                  <div class="col-xs-4">
                    ...
                    <!-- <a href="http://upload-cashflow.procarfinance.com/cashin_real.php?kode=H&status=Penggantian_Klaim_Asuransi" class="btn btn-primary btn-sm" style="margin-top: 25px;"><i class="fa fa-upload"></i> Upload</a> -->
                ...
                <input type="text" name="status" value="Pembayaran Suryamas" hidden>
                  ...
                  <div class="col-xs-4">
                    ...
                    <!-- <a href="http://upload-cashflow.procarfinance.com/cashin_real.php?kode=I&status=Pembayaran_Suryamas" class="btn btn-primary btn-sm" style="margin-top: 25px;"><i class="fa fa-upload"></i> Upload</a> -->
                ...
                <input type="text" name="status" value="Penerimaan_Cicilan" hidden>
                  ...
                  <div class="col-xs-4">
                    ...
                    <!-- <a href="http://upload-cashflow.procarfinance.com/cashin_real.php?kode=J&status=Penerimaan_Cicilan" class="btn btn-primary btn-sm" style="margin-top: 25px;"><i class="fa fa-upload"></i> Upload</a> -->
                ...
                <input type="text" name="status" value="Pengembalian Uang Muka" hidden>
                  ...
                  <div class="col-xs-4">
                    ...
                    <!-- <a href="http://upload-cashflow.procarfinance.com/cashin_real.php?kode=K&status=Pengembalian_Uang_Muka" class="btn btn-primary btn-sm" style="margin-top: 25px;"><i class="fa fa-upload"></i> Upload</a> -->
                ...
                <input type="text" name="status" value="Penjualan Kendaraan Inventaris" hidden>
                  ...
                  <div class="col-xs-4">
                    ...
                    <!-- <a href="http://upload-cashflow.procarfinance.com/cashin_real.php?kode=L&status=Penjualan_Kendaraan_Inventaris" class="btn btn-primary btn-sm" style="margin-top: 25px;"><i class="fa fa-upload"></i> Upload</a> -->
                ...
                <input type="text" name="status" value="Sewa Gedung" hidden>
                  ...
                  <div class="col-xs-4">
                    ...
                    <!-- <a href="http://upload-cashflow.procarfinance.com/cashin_real.php?kode=M&status=Sewa_Gedung" class="btn btn-primary btn-sm" style="margin-top: 25px;"><i class="fa fa-upload"></i> Upload</a> -->
                ...
                <input type="text" name="status" value="Terima Pengembalian Pinjaman" hidden>
                  ...
                  <div class="col-xs-4">
                    ...
                    <!-- <a href="http://upload-cashflow.procarfinance.com/cashin_real.php?kode=N&status=Terima_Pengembalian_Pinjaman" class="btn btn-primary btn-sm" style="margin-top: 25px;"><i class="fa fa-upload"></i> Upload</a> -->
                ...
                <input type="text" name="status" value="Pencairan PRK" hidden>
                  ...
                  <div class="col-xs-4">
                    ...
                    <!-- <a href="http://upload-cashflow.procarfinance.com/cashin_real.php?kode=O&status=Pencairan_PRK" class="btn btn-primary btn-sm" style="margin-top: 25px;"><i class="fa fa-upload"></i> Upload</a> -->
                ...
                <input type="text" name="status" value="Pinjaman/Hutang Pemegang Saham" hidden>
                  ...
                  <div class="col-xs-4">
                    ...
                    <!-- <a href="http://upload-cashflow.procarfinance.com/cashin_real.php?kode=P&status=Pinjaman_Hutang_Pemegang_Saham" class="btn btn-primary btn-sm" style="margin-top: 25px;"><i class="fa fa-upload"></i> Upload</a> -->
                ...
                <input type="text" name="status" value="Setoran Modal" hidden>
                  ...
                  <div class="col-xs-4">
                    ...
                    <!-- <a href="http://upload-cashflow.procarfinance.com/cashin_real.php?kode=Q&status=Setoran_Modal" class="btn btn-primary btn-sm" style="margin-top: 25px;"><i class="fa fa-upload"></i> Upload</a> -->
                ...
                <input type="text" name="status" value="Pencairan Deposito" hidden>
                  ...
                  <div class="col-xs-4">
                    ...
                    <!-- <a href="http://upload-cashflow.procarfinance.com/cashin_real.php?kode=R&status=Setoran_Modal" class="btn btn-primary btn-sm" style="margin-top: 25px;"><i class="fa fa-upload"></i> Upload</a> -->
                ...
                <input type="text" name="status" value="Pencairan Rekening B2B" hidden>
                  ...
                  <div class="col-xs-4">
                    <div class="form-group">
                      <label>Pencairan Rekening B2B (B) *</label>
                      <input type="number" name="realisasi" class="form-control" placeholder="(Rp)" required>
                    </div>
                  </div>
                  ...
                  <div class="col-xs-4">
                    ...
                    <button class="btn btn-success btn-sm" type="submit" name="simpan_S" style="margin-top: 25px;">
                      <i class="fa fa-save"></i> Simpan
                    </button>

                    <!-- <a href="http://upload-cashflow.procarfinance.com/cashin_real.php?kode=S&status=Pencairan_Rekening_B2B" class="btn btn-primary btn-sm" style="margin-top: 25px;"><i class="fa fa-upload"></i> Upload</a> -->
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Upload Realisasi Cash-In</h4>
          <br>
          <span>
            <a href="<?php echo base_url().'upload_excel/realisasi_cashin.xlsx' ?>" class="btn btn-info btn-xs">
        ...
        <div class="modal-footer">
          <form method="post" action="<?php echo base_url().'upload_excel/upload_realisasi_cashin.php' ?>" enctype="multipart/form-data">
