        ...
        <div class="col-sm-10">
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Data Proyeksi Cash-In</h3>
              ...
              <table class="table table-bordered" id="tableDT" style="margin-top: 10px;">
              	...
              	<tbody>
                      ...
                      <?php  
                          ...
                          $quer_cek = "SELECT * FROM tbl_cashinreal WHERE status='$status' AND tanggal='$tanggal'";
                      ...
                      <?php }else{ ?>
                        ...
                        <a href="<?php echo base_url().'real_otomatis_in/edit_amount_cashin/'.$data['id'] ?>" class="btn btn-warning btn-xs">Edit Amount</a>
                      ...
                      <form method="POST" action="<?php echo base_url().'real_otomatis_in/approve' ?>">
                        ...
                        ?>
                          ...
                          <button type="reset" class="btn btn-default btn-sm"><i class="fa fa-check"></i> Approve</button>
