...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <?php echo $this->session->flashdata('pesan_sukses'); ?>
      ...
      <h1>
        Input Data Bank (Cash-Out) Realisasi
      </h1>
    </section>
          ...
          <div class="box">
            <div class="box-header with-border">
              ...
              <span style="margin-left: 38%">
                <a href="<?php echo base_url().'upload_csv/upload_bank_realisasi.php' ?>" type="button" class="btn btn-info btn-xs">
                  <i class="fa fa-upload"></i> Upload Realisasi
                </a>
              </span>

              <span>
                <a href="<?php echo base_url().'bank_realisasi/view_inputan' ?>" type="button" class="btn btn-warning btn-xs"><i class="fa fa-eye"></i> Lihat Yang Sudah Diinput</a>
              </span>
            ...
            <div class="box-body">
              ...
              <!-- Isi Form -->
                ...
                <!-- FORM (C)-->
                <form method="post" action="<?php echo base_url().'bank_realisasi/tambah' ?>">
                <div class="row">
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Upload Realisasi Bank (Cash-Out)</h4>
          <br>
          <span>
            <a href="<?php echo base_url().'upload_excel/realisasi_bank.xlsx' ?>" class="btn btn-info btn-xs">
        ...
        <div class="modal-footer">
          <form method="post" action="<?php echo base_url().'upload_excel/upload_realisasi_bank.php' ?>" enctype="multipart/form-data">
