        ...
        <div class="col-sm-8">
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Update Data Realisasi Cashout</h3>
            ...
            <div class="box-body">
             ...
             <form method="post" action="<?php echo base_url().'edit_cashoutreal/update' ?>">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                  <label>Besar Realisasi</label>
                  <input type="number" name="realisasi" class="form-control" value="<?php echo $row['realisasi'] ?>"></input>
                </div>

                <button type="submit" class="btn btn-success btn-sm"><i class="fa fa-edit"></i> Update Data</button>
                <a href="<?php echo base_url().'edit_cashoutreal' ?>" class="btn btn-danger btn-sm"><i class="fa fa-times"></i> Batal</a>
