        ...
        <div class="col-sm-10">
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Data Allocated Cash</h3>
            ...
            <form method="post" action="<?php echo base_url().'input_allocated_cash/tampil_edit' ?>">
              <div class="row">
              ...
              <table class="table table-bordered" style="margin-top: 10px;">
              	...
              	<tbody>
              		...
              		<tr>
              			...
              			<td><?php echo number_format($data['allocated_cash'],0,'.',','); ?></td>
              			<td>
                      <a href="<?php echo base_url().'input_allocated_cash/edit/'.$data['id'] ?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i> Edit</a>   
                    </td>
              		</tr>
                  <?php 
                    }
