...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <?php echo $this->session->flashdata('pesan_sukses'); ?>
      ...
      <h1>
        Update Data Amount Proyeksi Cash-Out
        ...
        <div class="col-sm-8">
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Update Data Amount Cashout</h3>
            ...
            <div class="box-body">
             ...
             <form method="post" action="<?php echo base_url().'real_otomatis/update_amount_cashout' ?>">
