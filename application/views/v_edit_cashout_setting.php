  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Update Data Cash-Out </small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Update Cash-Out</li>
      </ol>
    </section>
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-sm-4 col-sm-offset-4">
              ...
              <h3>Update Data Cash-Out</h3>
              <hr style="border-width: 4px;">
              <form method="post" action="<?php echo base_url().'pengaturan_cashout/update_cashout' ?>">
