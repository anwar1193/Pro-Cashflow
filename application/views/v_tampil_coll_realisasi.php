...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <?php echo $this->session->flashdata('pesan_sukses'); ?>
      ...
      <h1>
        View Hasil Input Realisasi Collection
    ...
    <section class="content">
        ...
        <div class="col-sm-10">
          ...
          <div class="box">
            ...
            <div class="box-body table-responsive">
              ...
              <div class="row">
                <form method="post" action="<?php echo base_url().'collection_realisasi/view_inputan' ?>">
                  <div class="col-sm-2">
                ...
                <form method="post" action="<?php echo base_url().'collection_realisasi/hapus_cashin' ?>">
                  <div class="col-sm-3">
              	...
              	<tbody>
              		...
              		<tr>
              			...
              			<td style="text-align: center;">
              				<!-- <a href="<?php echo base_url().'collection_realisasi/edit_cashin/'.$data['id'] ?>" class="btn btn-success btn-xs"><i class="fa fa-edit"></i> Edit</a>  -->

              				<!-- <a href="<?php echo base_url().'collection_realisasi/hapus_cashin/'.$data['id'] ?>" class="btn btn-danger btn-xs" onclick="return confirm('Anda Yakin?')"><i class="fa fa-trash"></i> Hapus</a> -->

                      <a href="<?php echo base_url().'collection_realisasi/detail_cashin/'.$data['kode_status'].'/'.$data['tanggal'] ?>" class="btn btn-warning btn-xs" target="_blank">
      ...
      <!-- Tombol Kembali -->
      <a href="<?php echo base_url().'collection_realisasi' ?>" class="btn btn-danger"><i class="fa fa-backward"></i> Kembali</a>
