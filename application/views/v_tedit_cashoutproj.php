      ...
      <div class="row">
        ...
        <div class="col-sm-10">
          ...
          <div class="box">
            ...
            <form method="post" action="<?php echo base_url().'edit_cashoutproj/index' ?>">
              <div class="row">
              ...
              <table class="table table-bordered" style="margin-top: 10px;">
              	...
              	<tbody>
              		...
              		<tr>
              			...
              			<td>
                      <a href="<?php echo base_url().'edit_cashoutproj/edit/'.$data['id'] ?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i> Edit</a>   
                    </td>
              		</tr>
                  <?php 
                    }
