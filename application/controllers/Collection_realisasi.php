...
class Collection_realisasi extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('v_input_coll_realisasi');
	...
	public function view_inputan(){
		...
		if(isset($_POST['cari'])){
			$result = $this->m_input_cashin_real->view_inputan_collection($tgl);
		}else{
			$result = $this->m_input_cashin_real->view_inputan_collection_default();
		}
		

		$this->load->view('header');
		$this->load->view('sidebar');
		$this->load->view('v_tampil_coll_realisasi',array('row' => $result));
		$this->load->view('footer');
	}
	...
	public function hapus_cashin(){
		...
		if($id==''){
			...
			');
			redirect('collection_realisasi/view_inputan');
		}else{
