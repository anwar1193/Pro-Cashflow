...
class Input_cashout_real extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('v_input_cashout_real');
	...
	public function view_inputan(){
		...
		$this->load->view('header');
		$this->load->view('sidebar');
		$this->load->view('v_tampilan_cashout_real',array('row' => $result));
		$this->load->view('footer');
	}
	...
	public function update_cashout(){
		...
		if($result>0){
			...
			');
			redirect('input_cashout_real/view_inputan');
		}
	}
