...
class Input_cashin extends CI_Controller {
	...
	public function view_inputan(){
		...
		$result = $this->M_input_cashin->view_inputan($tgl);

		$this->load->view('header');
		$this->load->view('sidebar');
		$this->load->view('v_tampilan_cashin',array('row' => $result));
		$this->load->view('footer');
	}
	...
	public function hapus_cashin(){
		...
		if($id==''){	
			...
			');
			redirect('input_cashin/view_inputan');
		}else{
